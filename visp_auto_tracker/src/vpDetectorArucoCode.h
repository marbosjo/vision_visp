...
#ifndef __vpDetectorArucoCode_h__
#define __vpDetectorArucoCode_h__
...
/*!
  ...
  \code
#include <visp3/detection/vpDetectorArucoCode.h>
 ...
 */
class VISP_EXPORT vpDetectorArucoCode : public vpDetectorBase
{
protected:
